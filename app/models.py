...
class Wantoitem(models.Model):
    ...
    def scraping(self):
        ...
        except_file_main = '/workspace/app/pattern/except_main_list.txt'
        except_file_sub = '/workspace/app/pattern/except_sub_list.txt'
        contain_title = '/workspace/app/pattern/contain_title.txt'
        except_title = '/workspace/app/pattern/except_title.txt'
