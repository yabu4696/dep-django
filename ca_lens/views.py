...
def detail(request, slug):
    ...
    return render(request, 'ca_lens/detail.html', {
        'item':item,
...
def maker_index(request):
    ...
    return render(request, 'ca_lens/maker_list.html', {
...
def maker_detail(request, slug):
    ...
    return render(request, 'ca_lens/maker_detail.html', {
        'items':items,
        'maker':maker,
        })
...
def exclusion(request,slug):
    if not request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            return render(request, 'ca_lens/exclusion.html', {
                'item':item, 
                'main_list':main_list,
                'sub_list':sub_list
                })
...
def contact(request):
  ...
  if form.is_valid():
     ...
     return redirect('ca_lens:done')

  return render(request, 'ca_lens/contact.html',{'form': form})

def done(request):
   return render(request, 'ca_lens/done.html')
